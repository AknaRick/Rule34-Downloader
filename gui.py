...
class Ui_Rule34Downloader(object):
    def setupUi(self, Rule34Downloader):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("../../../Downloads/down-512.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.ckboxBatchDownload = QtWidgets.QCheckBox(self.centralwidget)
        self.ckboxBatchDownload.setObjectName("ckboxBatchDownload")
        self.verticalLayout.addWidget(self.ckboxBatchDownload)
    ...
    def retranslateUi(self, Rule34Downloader):
        ...
        self.ckboxBatchDownload.setToolTip(_translate("Rule34Downloader", "Reads a text file and downloads it in a batch"))
        self.ckboxBatchDownload.setText(_translate("Rule34Downloader", "Batch Download"))
